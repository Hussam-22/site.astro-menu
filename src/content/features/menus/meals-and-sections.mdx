...
- **Start by Adding Sections**:
  ...
  - Astro-Menu will automatically translate your sections into the languages configured in your <FeatureLink link='/docs/translation-settings' text='translation settings' />.
...
When a section is added to a menu, Astro-Menu automatically translates it into the languages you selected in the <FeatureLink link='/docs/translation-settings' text='translation settings' /> page.
