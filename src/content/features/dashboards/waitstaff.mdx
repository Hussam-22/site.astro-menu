...
1. **Customer Self-Ordering**  
   ...
   This feature can be enabled or disabled based on your restaurant's needs via the <FeatureLink link='/features/branches/manage-branch' text='branch settings' />.
...
Each Waitstaff team member or device has a unique access URL to ensure secure and streamlined operations. You can retrieve these URLs for your staff from the <FeatureLink link='/features/branches/waitstaff' text={`Branch's Staff Access Link Tab`} />.
